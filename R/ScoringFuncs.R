...
# Score an untriggered scale by taking the row mean of its available items.
# This is used for scores, such as ONA, that have no opening trigger.
score_NORSE_mean <- function(dat, vars = names(dat)) {
