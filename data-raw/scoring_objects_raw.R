...
internal.names.nf3 <- c("Q34", "Q78", "Q122", "Q123")
...
needs.names.nf3 <- c("Q71", "Q74", "Q152", "Q153")
...
usethis::use_data(internal.names.nf3, overwrite = TRUE)
...
usethis::use_data(needs.names.nf3, overwrite = TRUE)
